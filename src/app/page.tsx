  ...
  return (
    <div className="w-full">
      <div className="flex flex-col">
        <section className="container mx-auto flex-grow flex items-center justify-center text-center py-20 px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-8">
          <div className="container mx-auto flex justify-center items-center flex-col px-4 sm:px-6 lg:px-8">
