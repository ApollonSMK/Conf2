...
export default function DescobertaPage({ params }: { params: { slug: string } }) {
    ...
    const gmapsUrl = `https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=${descoberta.location.lat},${descoberta.location.lng}`;
           ...
           <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <Card>
                    <CardHeader className="p-0">
                        ...
                        <div className="grid grid-cols-2 gap-px bg-border">
                             {descoberta.images.slice(1).map(image => (
            ...
            <div className="lg:col-span-1 space-y-8">
                <Card>
                 ...
                 <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">Contactos e Informações</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <Button asChild className="w-full"><Link href={descoberta.contact.website} target="_blank" rel="noopener noreferrer"><Globe className="mr-2"/> Visitar Website</Link></Button>
                        <div className="grid grid-cols-2 gap-4">
                            <Button asChild variant="secondary" className="w-full"><Link href={`mailto:${descoberta.contact.email}`}><Mail className="mr-2"/> Email</Link></Button>
                            <Button asChild variant="secondary" className="w-full"><Link href={`tel:${descoberta.contact.phone}`}><Phone className="mr-2"/> Telefone</Link></Button>
                        </div>
